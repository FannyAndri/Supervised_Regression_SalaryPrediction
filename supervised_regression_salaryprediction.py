...
Original file is located at
    https://colab.research.google.com/drive/1RkDOLD-5ulhu-THquylGbKZDuMQ33C10
...
# Make predictions
y_test_pred = model_rf.predict(X_test.values.reshape(-1, 1)) # Reshape X_test
y_train_pred = model_rf.predict(X_train.values.reshape(-1, 1)) # Reshape X_train

# Visualize predictions
plt.figure(figsize=(10, 6))
plt.scatter(X_test, y_test, color='blue', label='Actual')
plt.scatter(X_test, y_test_pred, color='red', label='Predicted')
plt.title('Random Forest Regression: Test Data vs Predictions')
